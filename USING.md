...
| `CHESHIRE_SFM_LOCAL_PASSES=0` | after every bundle adjustment, upstream's outlier and unstable-pose passes over the whole scene; the default restricts them, exactly, to what the solve can have changed under the local strategy (docs/04, 0.3.4: 605 s of a 1908 s node at 884 views) |
