...
| `CHESHIRE_GPU_KNN_LAYOUT=0` | the visibility knn kernel with the points in their original order and a 96-frame stack; the default stores them in leaf order and sizes the stack to the tree (same answers, docs/04 6s) |
